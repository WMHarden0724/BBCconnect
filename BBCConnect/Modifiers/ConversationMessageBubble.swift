...
extension View {
	func conversationMessageBubbleStyle(isFromYou: Bool, shouldSendInTheFuture: Bool = false) -> some View {
		modifier(ConversationMessageBubbleStyle(isFromYou: isFromYou, shouldSendInTheFuture: shouldSendInTheFuture))
	}
}
...
func OtherAttachmentView(_ thumbnail: Image, fileName: String, docType: String, fileSize: String, isFromYou: Bool, shouldSendInTheFuture: Bool) -> some View {
	...
	.conversationMessageBubbleStyle(isFromYou: isFromYou, shouldSendInTheFuture: shouldSendInTheFuture)
}
